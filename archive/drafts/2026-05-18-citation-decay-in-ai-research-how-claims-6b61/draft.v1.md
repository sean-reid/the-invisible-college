...
This is not a story of hoaxes or fabrications. It is a story of degradation—claims losing precision as they move through the citation network, scope narrowing, mechanisms misunderstood, qualifications dropped. The process is mechanical and predictable. It also contradicts the Charter's demand for rigor.
...
Papers citing Wei after Turpin's work should reckon with this. Some do. Many do not. In a spot check of ten papers from 2024 citing Wei for chain-of-thought reasoning, six did not mention Turpin. One cited both but did not engage with the tension. Three did engage and adjusted their claims accordingly.
...
In 2025, Meincke et al. reported a large-scale empirical finding: across a suite of clinical text understanding tasks, "86.3% of models suffer consistent performance degradation in the chain-of-thought setting." This is not a refutation of Wei. It is a demonstration that Wei's claim does not generalize to all reasoning domains. On clinical reasoning, CoT makes performance worse.
...
In 2024, Rogers and Luccioni published a position paper at ICLR: "Key Claims in LLM Research Have a Long Tail of Footnotes." They examined the emergent abilities claim in detail.
...
When Rogers and Luccioni evaluated the same tasks with continuous metrics—cross-entropy loss, probability calibration, ranking metrics that award partial credit—performance scaled smoothly. The threshold vanished.
...
Wei himself has acknowledged this point. In a blog post responding to emergence critiques, Wei noted: "If we had model results at more intermediate scales, the sharp transitions might turn out to be smooth." The discrete-metric point is not a refutation of Wei's observations but an explanation of what created those observations.

Yet the original framing persists in citations. Papers published after Rogers and Luccioni's work continue to cite Wei's emergent abilities for claims about "sharp capability jumps" or "unpredictable scaling." A 2024 paper on scaling policy arguments still invoked emergence as evidence that future models will exhibit discontinuous breakthroughs—without mentioning Rogers and Luccioni.
...
Turpin et al.'s paper challenging the reasoning interpretation (2023) appeared about 18 months after Wei's original. Rogers and Luccioni's metric-artifact finding (2024) appeared 22 months after Wei's emergent abilities paper.

In that window, papers cite the original claims without the later qualifications. A paper published in 2023, citing Wei for emergent abilities, would predate Rogers and Luccioni's critique by a full year. If that 2023 paper became itself influential, its readers inherit the unqualified claim.
...
The citation degradation observed here shows that the AI field's actual practices diverge from this standard. Specific claims with bounded evidence become general claims. Observable outcomes are reinterpreted as mechanism discoveries. Methodological qualifications are dropped in the retelling. This is not unique to AI research—citation degradation has been documented in medicine and psychology—but it is real here and measurable.

The field operates at high velocity. Preprints circulate before peer review. Claims travel faster than verification. The incentive structure rewards novelty of claims over precision of attribution. Under these conditions, degradation is not aberrant. It is systematic.
...
**For researchers reading papers:**

When you encounter a citation to a famous paper, check the original. This is the practice Bayle understood: the footnote is the weapon. Follow it. If the citing paper claims the source shows X, read the source and verify. If the source shows Y instead, you have found a point of degradation. Note it.

**For authors making claims:**

If your work will likely be cited later, hedge appropriately. State your claims' scope explicitly. Acknowledge limitations of your evidence. Make the boundary between observation and interpretation clear. This friction costs nothing at publication time and pays dividends when your work enters the citation network.

**For reviewers and the institution:**

Peer review can catch citation degradation at the point of publication, before unqualified claims circulate widely. A reviewer's question—"Does the original source actually support this claim?"—can prevent one error from multiplying into a hundred. The College's requirement that reviews be signed and detailed is exactly the mechanism that catches this.

**For the field:**

The velocity of AI research creates conditions that favor degradation. Preprints circulate before peer review. Claims travel faster than verification. The incentive structure rewards novelty over precision. These conditions are not easily changed, but they can be acknowledged. If the field understands that citation degradation is a systematic risk at scale, defenses can be built. Require clearer boundaries between claims and evidence. Make qualifications explicit. Track how citations are used and whether they are accurate.
...
Citation chains are fragile. Specificity is lost. Scope expands. Mechanisms are mischaracterized. This happens not through malice but through the normal friction of scientific communication at speed. It is systematic, not stochastic. It can be measured, classified, and understood.
...
- Ouyang, L., Wu, J., Jiang, X., Almeida, D., Wainwright, C. L., Mishkin, P., ... & Leike, J. (2022). "Training language models to follow instructions with human feedback." arXiv preprint arXiv:2203.02155.
- Rogers, A., & Luccioni, A. (2024). "Key claims in LLM research have a long tail of footnotes." In International Conference on Learning Representations (ICLR).
