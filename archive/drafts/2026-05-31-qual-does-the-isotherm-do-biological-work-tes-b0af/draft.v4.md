...
The *Naturgemälde* and accompanying text of the *Essai* place the upper boundary of the *Région de Quinquinas* (the cinchona-forest zone) at approximately 1,440 toises on the Chimborazo profile.[^toise] The *Région de Mousses* (the sub-páramo moss zone) begins just above this elevation. Humboldt's thermometer readings at the uppermost cinchona stations give temperatures in the 12–13°C range for that zone boundary. The modern GBIF-derived Sørensen analysis shows the sharpest transitions in the Chimborazo dataset at 3100–3200 m and 3400–3500 m. The disagreement - approximately 300–400 m upward from the *Essai*'s ~2,807 m figure - is consistent with known warming of 0.6–1.0°C per century in the tropical Andes (Vuille and Bradley, 2000), which at a lapse rate of 6°C/1000 m would shift isotherms upward by 100–170 m per century and 200–340 m over two centuries. It is also consistent with imprecision in the original zone boundaries, which were partly qualitative and partly reconstructed from sparse collections made at speed during a single ascent.

[^toise]: 1 toise = 1.949 m (toise de Paris, the unit used in the *Essai*), yielding approximately 2,807 m.

This upward shift - 300–400 m over roughly two centuries - is the one positive biogeographic finding this analysis produces: the GBIF data locates the Chimborazo forest-páramo boundary substantially higher than the *Essai* placed it, and the magnitude is consistent with known Andean warming rates. The uncertainty about how much of the shift reflects real thermal displacement versus imprecision in Humboldt's original zone placements is genuine, but the finding that the boundary has moved upward is not in doubt.
...
The isotherm question remains open. The reason it remains open is not that the proposed method fails - it does not - but that this execution encountered two compounding failures, both diagnosed precisely.
...
**What the test as executed produced.** The execution yielded no evidence discriminating altitude from temperature as the organizing variable. The Ecuador pair shows both hypotheses predicting identical boundary elevations (same regime, similar lapse rates), so the pair is internally consistent but externally uninformative on the core question. The Peru pair is not commensurable. This is the failure mode the proposal anticipated - "insufficient lapse rate variation, reported as a null design rather than a falsified hypothesis" - compounded by the ecological non-equivalence of the dry pair. The test was not run; neither hypothesis has been tested.

---

## Conclusion

The *Essai*'s isotherm claim - that temperature, not altitude, organizes altitudinal vegetation zones - can in principle be tested by comparing vegetation zone boundaries across Andean mountains with different lapse rates. The GBIF occurrence data is sufficient to identify candidate assemblage transitions and richness profiles within each mountain, and the Sørensen dissimilarity method correctly locates the Ecuadorian forest-páramo boundary at 3150 m on both Chimborazo and Cotopaxi. Two obstacles prevented the cross-regime comparison from being executed with the present mountain selection, and both are now precisely characterized.

The first is instrumental: ERA5 at 9 km cannot resolve the documented moisture-regime lapse rate contrast, compressing a 1.0°C/1000 m signal to an indistinguishable 0.05°C/1000 m. WorldClim v2.1 at 1 km, the pre-registered instrument, would provide the required discrimination. The second is a selection error: the dry Peru mountains (Misti, Chachani) lack a forest-grassland ecotone at any sampled elevation. Their candidate boundaries mark within-puna transitions on hyperarid slopes where cloud forest is absent, and no lapse rate data can make those boundaries equivalent to Ecuador's cloud-forest/páramo boundary. The selection criterion (moisture-regime contrast) was necessary but not sufficient; future site selection must also require that a forest-grassland ecotone exists on both sides of the contrast. The eastern Andean slopes of Peru, which receive Amazon-basin moisture, offer candidates.

One positive finding emerges from the historical comparison: the modern GBIF-derived Chimborazo forest-páramo boundary sits 300–400 m above the position recorded in the *Essai* (~2,807 m). The magnitude is consistent with two centuries of documented Andean warming at rates of 0.6–1.0°C per century. Whether the shift is entirely attributable to warming or partly to imprecision in the original zone boundaries cannot be resolved without early-19th-century temperature station data from the Chimborazo massif; those records do not exist.
