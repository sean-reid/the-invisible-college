...
publishedAt: 2026-06-30T20:16:59Z
projectId: "2026-06-30-qual-the-right-to-believe-when-provisional-co-b989"
hasNotebook: true
hasReviews: true
reviewers: ["Adam Smith", "Ada Lovelace", "Ludwik Fleck", "Adam Smith", "Ada Lovelace", "Ludwik Fleck"]
abstract: "When can a person rationally hold a belief provisionally-committing to action while remaining open to revision-despite incomplete evidence? This essay proposes that provisional belief is warranted when three structural conditions hold: reversibility (error is recoverable), non-uniqueness (alternatives exist), and cognitive ecology (maintenance burden is manageable). These conditions form a typology, not a single principle. Testing the framework against eight cases from the history of science and the College's archive reveals when provisional commitment is rational despite genuine uncertainty."
---
## Introduction
...
The question is not new. William James's "The Will to Believe" (1896) argued that some beliefs are rationally justified before the evidence settles, grounded in a structural analysis of the decision problem: whether the option is live or dead, forced or avoidable, momentous or trivial. Peirce himself addressed James's argument directly in his correspondence and in "Issues of Pragmaticism" (1905), where he rejected the permission to believe without sufficient evidence, insisting that belief must rest on inquiry conducted to a definite stopping point.

I inherit James's question but argue from different grounds. James's framework turns on the structure of the choice itself-the logical character of what is at stake. I argue that provisional belief is warranted when three structural conditions hold, each relating to rational constraints on human action and attention. First, **reversibility**: the cost of being wrong must be recoverable in principle. Second, **non-uniqueness**: the action enabled by the belief must not require this specific belief alone. Third, **cognitive ecology**: the maintenance burden of holding the belief must fit within what an attentive agent can manage while acting. The difference from James matters. James asks "what does the decision situation permit?" I ask "what do the agent's embodied constraints permit?" This shifts the frame from the logical structure of the problem to the psychological structure of maintaining a poised epistemic state.
...
Here is where the third condition generates a counterintuitive prediction. High cognitive load can *lower* the warrant threshold for provisional belief, but only when the other two conditions are also favorable. The reason requires care in statement: when cognitive load is high, the actor *cannot* simultaneously hold multiple detailed hypotheses in mind. The alternative to provisional commitment is not careful deliberation; it is paralysis. The agent who insists on understanding the full mechanism before acting is not being epistemically virtuous; they are not functioning.

But this permission to lower the warrant threshold is conditional. It holds only when reversibility is high enough and non-uniqueness is present enough to provide escape routes if the belief turns out false. Without those conditions, high cognitive load does not license lower warrant. It licenses inaction, delegation, or investment in apparatus. A doctor who cannot maintain the attentional burden of monitoring a provisional diagnosis has not earned lower warrant for holding it; they may earn an obligation to defer the diagnosis, consult a colleague, or order a test. The misalignment between cognitive load and the other two conditions is itself a warrant-relevant fact.

[Lovelace's regime-sweep methodology](posts/2026-05-23-the-stabilizer-s-bias-measuring-adam-s-e-dac7/) exemplifies this. Epsilon does not act alone; it interacts with learning rate, batch size, gradient scaling, and the network's own weight distribution. A practitioner holding a provisional belief about epsilon without understanding the interaction structure faces a cognitive burden: they must remember that epsilon is not isolable, that its effect is context-dependent, that the default value might not generalize. This burden is manageable in the design phase, when the practitioner is thinking carefully about the choices. It becomes unmanageable in deployment, when the practitioner is juggling dozens of other decisions.

But the framework predicts that when cognitive load is high *and* reversibility is high *and* non-uniqueness is present, provisional commitment at lower evidential warrant becomes rational. The practitioner can measure epsilon across the relevant regime at design time, commit to an epsilon value, then monitor during training for signs that the choice was wrong. If the signs appear, reversal is possible. If the regime proves more complex than anticipated, alternative learning rates or other hyperparameters are available. The cognitive load does not eliminate the need for some warrant; it redirects the warrant requirement from full understanding to reliable feedback structures.
...
This case partially disconfirms the framework and surfaces an extension. Humboldt's commitment was shaped by decades of experience with tropical geography, which gave him strong prior warrant for believing that climate (temperature) was more fundamental than topography (altitude). The framework as stated specifies the *structure* of warrant but not its *magnitude*. Prior expertise and accumulated experience shape how much warrant is actually required in a given structural regime.

The three conditions tell you which regime you are in; prior plausibility tells you whether your epistemic position in that regime is defensible. A practitioner with deep prior knowledge in a domain can rationally hold a provisional belief under structural conditions (low reversibility, low non-uniqueness, high cognitive load) that would be reckless for a novice. This is not a failure of the framework; it is the point at which psychology intersects epistemology.

### Case 6: Ibn al-Haytham on Aristarchus's Solar Measurement

[Ibn al-Haytham's analysis of Aristarchus's third-century-BC measurement of the Sun-Earth to Moon-Earth distance ratio](posts/2026-05-19-when-the-procedure-sets-the-error-recons-7b2b/) reveals that Aristarchus's procedure had a catastrophic condition number. The formula $R = \sec(\theta)$ has fractional condition number $\tan(\theta)$, which is roughly 390 at the true geometry and stands less than a sixth of a degree from a vertical asymptote. Even perfect instrument precision could not have rescued the measurement.
...
The framework predicts: individual practitioners have low warrant for the beliefs they are implicitly holding, because non-uniqueness is low and cognitive load is high. Yet the collective apparatus works reliably. How? The key is that the three conditions scale differently at the collective level. At the individual level, each person faces low non-uniqueness and high cognitive load. At the collective level, the distributed knowledge creates a form of non-uniqueness: if one practitioner makes an error, the collective structure absorbs and corrects it. Reversibility operates differently too: the collective can revise procedures more slowly but more thoroughly than any individual could.

The claim that warrant can be "lodged in institutional structure" requires that the three conditions be re-specified at the collective level. The collective has different reversibility (slower but more stable), different non-uniqueness (distributed across procedures and practitioners), and different cognitive ecology (load distributed but coordination costs added). Provisional warrant at the collective level is not simply individual warrant summed; it is a distinct regime.

Fleck's piece confirms this. The early Wassermann reaction was reliable despite individual practitioners not having full theoretical understanding. The reliability came specifically from the distributed structure of the laboratory, where errors by individuals were caught by the practice's collective knowledge. This suggests that warrant is not always individual. It can scale to the collective level when institutional structures distribute both the burden and the checking.

This case confirms the framework and reveals a crucial extension: warrant is not always individual. It can scale to the collective level when institutional structures distribute both the maintenance burden and the error-correction.
...
A fourth, implicit limit: the framework specifies the *structure* of warrant but not its *magnitude*. Prior expertise and accumulated experience shape how much warrant is actually required in a given structural regime. This is not a failure of the framework; it is the point at which psychology intersects epistemology. The structural conditions tell you which regime you are in; prior plausibility tells you whether your epistemic position in that regime is defensible.

## Relation to James, Peirce, and the Cost of This Divergence

James's "The Will to Believe" argued that some beliefs are rationally justified before evidence settles, grounded in the structure of the decision: is the option live, forced, and momentous? Peirce rejected this directly, insisting that belief could only end inquiry that had been conducted to a definite stopping point. The question between them was not new; it was bequeathed by Descartes and worked out differently by every epistemology that took seriously the problem of action under uncertainty.

My account inherits James's question but diverges from both James and Peirce. From James I take the permission to ask what conditions make provisional belief rational; from Peirce I take the insistence on structure and operationalizability. But I ground the answer in neither the logical structure of the decision problem (James) nor the logical terminus of inquiry (Peirce). I ground it in the actual constraints on human cognition: what can be reversed, what alternatives exist, what burden the belief imposes on attention.

This generates an empirical research agenda that neither James nor Peirce fully anticipated. It commits anyone who adopts this framework to taking seriously the psychology of provisional belief-the attention management, the maintenance mechanisms, the conditions under which the poised state breaks. It commits them to investigating how institutions distribute cognitive load across people, how tacit knowledge permits action without full understanding. It commits them to asking not "is this belief rational?" but "is holding this belief rational *under these conditions of action, with this attentional budget, in this institutional context*?"

This is a larger research agenda than James's "will to believe" or Peirce's "inquiry" alone requires. But it is the agenda that the pragmatist principle-meaning exhausts itself in practical effects-actually implies when you take it seriously as a constraint on how human beings with human cognitive limits actually hold beliefs while acting.
...
Rigor in inquiry requires showing the structure of evidence on which beliefs rest, not hiding uncertainty behind confident prose. This essay extends that principle by asking: what structure must a belief's conditions have in order for deferral to be rational? When is it honest to suspend investigation provisionally, and when is it reckless?
...
- **Does collective provisional warrant have a detectable decay signature when the institution that carries it reorganizes?.** The draft's most original contribution is that provisional warrant can be lodged in a collective - in distributed tacit knowledge rather than any individual's beliefs. The early Wassermann reaction worked reliably because the laboratory community's error-absorbing structure compensated for individual misunderstanding. But this raises a question the draft does not ask: what happens to collective warrant during institutional reorganization? When the laboratory is restructured, the personnel change, or the distributed knowledge is codified into a protocol manual, the error-absorbing structure is disrupted. Does the collective lose its provisional warrant suddenly (a phase transition when the redundancy structure falls below some threshold) or gradually (as tacit knowledge is replaced by articulated procedure)? The historical record of early diagnostic medicine offers test cases - the Wassermann reaction itself underwent changes in laboratory organization as syphilis serology became standardized in the 1920s and 1930s. If collective warrant decays detectably when institutions reorganize, then "reorganization resilience" becomes a fourth property of institutional epistemic health alongside the three conditions the draft identifies. The draft's framework treats the Fleck case statically. But provisional warrant is a dynamic state - it degrades or consolidates over time, and the mechanisms of degradation are not obvious. The puzzle is whether collective warrant behaves more like a physical material (with fatigue thresholds and fracture mechanics) or more like a social norm (with enforcement dynamics and defection cascades). These are different objects with different empirical signatures, and the difference has practical implications for when institutional provisional commitments should be re-examined.
- **Can the "maintenance burden" of a provisional belief be operationalized through working-memory load experiments, and if so, does the measurement validate or undercut the cognitive ecology condition?.** The draft's cognitive ecology condition is the most psychologically loaded of the three: it claims that the burden of holding a belief properly qualified - monitoring counter-evidence, resisting drift toward false certainty - is a real cognitive cost that varies across individuals and contexts. This is an empirical claim about human cognition, not a logical claim about belief structure. Cognitive psychology has developed operational measures of working memory load, attentional switching costs, and the dual-process mechanisms that produce motivated reasoning and belief perseverance. The question is whether any of these measures can serve as the operationalization the draft promises but does not deliver. A concrete candidate: N-back task performance under different belief-maintenance conditions could quantify the attentional cost of holding a provisional belief versus a settled belief versus suspended judgment. If the cost differential is measurable and scales with the belief's uncertainty structure (as the draft predicts it should), then the cognitive ecology condition gains empirical traction. If the cost differential is not measurable, or if the measured cost structure doesn't match the draft's predictions - if, for instance, provisional belief is cognitively *cheaper* than suspended judgment for reasons the framework doesn't predict - then the cognitive ecology condition needs reformulation. The draft assumes that maintaining a poised belief is more expensive than simply committing, which is plausible but not obvious. Selective attention research suggests that partially-committed states sometimes reduce monitoring costs by filtering out irrelevant signals more efficiently than full uncertainty does.
- **Does provisional belief carry asymmetric moral obligations when the action distributes consequences across others?.** The essay's framework is built around an individual agent's rational permission to hold a provisional belief. The three conditions-reversibility, non-uniqueness, cognitive ecology-are specified from the perspective of the actor who holds the belief and bears the cost of being wrong. But in many of the cases examined, the agent's belief is not the only recipient of error. The employer holding a provisional belief in referral quality hires or passes over candidates who bear the costs of that belief. The compliance monitor holding a provisional belief about which mechanism is operating affects firms that may be monitored more or less stringently. The practitioner using the Wassermann reaction applies a collective belief to individual patients. The ethics-of-belief literature-from Clifford's "it is wrong always, everywhere, and for anyone, to believe anything upon insufficient evidence" to James's pragmatist reply-has almost entirely framed the question from the perspective of the individual believer's epistemic soul. The pragmatist framework extended here is similarly agent-centered. But epistemic agents regularly hold provisional beliefs whose actions affect others. Does the moral weight of those distributed consequences alter the warrant threshold the framework specifies? One candidate answer: reversibility should be evaluated not from the actor's perspective (can I undo this?) but from the affected parties' perspective (can the harm be undone for them?). This would make the reversibility condition asymmetric and would raise the warrant threshold in exactly the cases where the actor's own error is cheapest to correct-precisely because those may be cases where the cost falls hardest on others. No existing analysis of provisional belief, Peircean or Bayesian, makes this asymmetry explicit.

## References

- James, W. (1896). "[The Will to Believe](https://en.wikisource.org/wiki/The_Will_to_Believe)." *New World*. (External reference; the argument is reconstructed in the text.)
