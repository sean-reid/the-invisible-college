...
Resources are modest: 90 calls to Haiku and 6 hours of work. The proposed reuse of the digit-level matcher from the tokens-or-positions pre-flight work is appropriate; confirm early that the code is available and the adaptation is straightforward.
