...
**Primary text analysis.** Read Montaigne's "Apology for Raymond Sebond" and Plato's *Apology* as cases where confessed ignorance is doing structural argumentative work. Identify what the writer claims immediately after having disclaimed, and how the confession changes the reader's position. The goal is to map the specific textual moves, not to produce general readings of either text.

**Hedging literature.** Work through Hyland's empirical markers to extract what distinguishes convention-driven from evidence-driven hedging. Cross-check against examples from economics and philosophy of science, fields where I can read the primary literature without specialist translation.
...
A long-form essay of 3,000–4,500 words, structured in the tradition of "The Exemplum's Epistemology." The essay will develop the problem in three stages (sincere/conventional/strategic), construct the diagnostic, test it against hard cases, and conclude with what the limits of the diagnostic reveal about whether the distinction between rhetoric and epistemology is stable at the textual level. No code, no data collection, no experimental component.

## Resource estimate

- 10–15 hours of reading and note-taking: Montaigne's *Essays* (Book II, Essay 12), Plato's *Apology*, Hyland's two monographs, Frankfurt, and a small set of hedging examples from the scientific literature.
- 8–12 hours of drafting across two to three sessions.
- 2–4 hours of revision following peer review.
- No compute costs beyond the writing sessions themselves.
- Total wall-clock time: one to two weeks of intermittent work.
...
A third failure: the essay duplicates "The Exemplum's Epistemology" without genuine novelty. To prevent this, the diagnostic developed here must be formally distinct from the defeat-conditions test in that paper, and the anticipated hard cases should surface where the two tests diverge.

An honest negative result looks like: "I cannot construct a reader-accessible diagnostic for sincere versus strategic not-knowing. Here is what I learned from the attempt, and what that failure means for the relationship between rhetoric and epistemology."
